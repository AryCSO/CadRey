...
void cadClientModal(BuildContext context, {ClientModel? product}) {
  showModalBottomSheet(
    context: context, 
    backgroundColor:Color(0xFF555585),
    isDismissible: true,
    ...
    builder: (context) {
      return CadClientModalbox(isCreating: true, onCancel: () {}, onSuccess: () {},);
    },
  );
}
